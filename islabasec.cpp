...
#define GA_POPSIZE		30	// размер популяции
#define GA_MAXITER		200		// максимальное число итераций
#define GA_ELITRATE		0.1f		// элитарность
#define GA_MUTATIONRATE	 0.5f			// мутации
...
void mutate(ga_struct& member)
{
	...
	member.str[ipos] = ((member.str[ipos] + delta) % 100);
}
...
{
	cout << "поколение: " << gav[0].str << " (" << gav[0].fitness << ")" << endl;
}
